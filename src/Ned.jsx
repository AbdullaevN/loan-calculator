          ...
          <div className="right print  table-responsive">
            ...
            <div>
              {total < 100 && (
                <>
                  <div class="error">
                    {`ЕЖЕМЕСЯЧНЫЙ ПЛАЖЕТ ДОЛЖЕН СОДЕРЖАТЬ НЕ МЕНЕЕ 100  долларов `}
                    {/* ${currency.title} */}
                  </div>
                </>
              )}
              ...
              <div className="error">
                {selectedCurrency === "сом"
                  ? total < 8600 &&
                    `ЕЖЕМЕСЯЧНЫЙ ПЛАЖЕТ ДОЛЖЕН СОДЕРЖАТЬ НЕ МЕНЕЕ 8800 сом 87.42`
                  : ""}
              </div>
              <div className="error">
              ...
              <div className="error">
                {selectedCurrency === "тенге"
                  ? total < 45000 &&
                    `ЕЖЕМЕСЯЧНЫЙ ПЛАЖЕТ ДОЛЖЕН СОДЕРЖАТЬ НЕ МЕНЕЕ 44500 тенге по курсу 446.94`
                  : ""}
              </div>
              <div className="error">
                {selectedCurrency === "сум"
              ...
              <div className="error">
                {selectedCurrency === "рубль"
                  ? total < 7500 &&
                    `ЕЖЕМЕСЯЧНЫЙ ПЛАЖЕТ ДОЛЖЕН СОДЕРЖАТЬ НЕ МЕНЕЕ 7500 рубль по курсу 74.76`
                  : ""}
              </div>
            </div>
